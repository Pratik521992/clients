...
/*Alter this file to change the style of login components such as "welcome cgriffith" and auth flow pages
 * Objects such as "Nav" are defined in AmplifyUI.js
 * */
...
var Container = exports.Container = {
    ...
    paddingRight: '15px',
    height: '100%',
    	background: 'linear-gradient(rgba(231,235,238,.25),rgba(231,235,238,.95))'
};
